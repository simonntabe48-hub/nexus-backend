...
export default defineConfig({
  plugins: [react()],
  base: process.env.VITE_BASE_PATH || ''/I'm encountering an error and reviewing the docs at https://vercel.com/docs/errors/DEPLOYMENT_NOT_FOUND.md to understand what's happening.
